...
do
    ...
    outfn_clim=${outfn/.nc/_clim.nc}  # ${outfn}_clim_amip.nc
    echo $outfn_clim
    cdo ymonmean $outfn $outfn_clim

    # Define output file
    varnm=$(echo $fn | awk -F '_' '{print $1}')
    amip_fn=${outfn_clim/.nc/}
    echo "name is $amip_fn"
    outfn_final="$outdir/$outfn_clim"

    outfn1=${outfn_clim/.nc/_1.nc}
    ...
    cdo -settaxis,0000-01-01,00:00:00,30day $outfn1 $outfn_final
    ...
    ncatted -O -a units,time,o,c,"days since 0000-01-01 00:00:00.0" $outfn_final
